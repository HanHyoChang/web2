...
<html>
    <head>
        ...
        <sciprt src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <script src="./js/login.js"></sciprt>
    </head>
        ...
        <body>
            <nav class="navbar navbar-default">
                <div class="navbar-header">
                    ...
                    <button type="button" class="navbar-toggle collapsed" data-toglle="collapse" data-target="#bs-exmaple-navbar-collapse-1" aria-expanded="false">
